      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="p-8 bg-white rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(val: string) => handleChange("breed", val)}
              >
                <SelectTrigger className="mt-1">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="시추">시추</SelectItem>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(val: string) => handleChange("personality", val)}
              >
                <SelectTrigger className="mt-1">
                  <SelectValue placeholder="성격을 선택해주세요" />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="flex gap-3 mt-8">
            ...
            <Button onClick={handleSubmit} className="flex-1 bg-yellow-300 text-gray-900">
              완료
            </Button>
          </div>
        </div>
