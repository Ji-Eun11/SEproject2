        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 mb-6">
          <div className="flex justify-center mb-8">
            <div className="w-40 h-40 rounded-full overflow-hidden bg-gray-100">
              {pet.photo ? (
                ...
                <div className="flex items-center justify-center w-full h-full text-gray-400">사진 없음</div>
              )}
            </div>
          </div>
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div className="space-y-6">
              ...
              <div>
                <p className="text-sm text-gray-500 mb-1">품종</p>
                <p className="text-gray-900">{pet.breed || "정보 없음"}</p>
              </div>
            </div>
            <div className="space-y-6">
              <div>
